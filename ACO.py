...
class ACO:
    ...
    def __init__(self, grafo, num_formigas, alfa, beta, iteracoes, evaporacao, q):
        self.grafo = grafo
        self.q = q
            ...
            for aresta in self.grafo.arestas:
                ...
                for k in range(self.num_formigas):
                    ...
                    if aresta in arestas_formiga:
                        somatorio_feromonio += (self.q / self.grafo.obterCustoCaminho(cidades_visitadas[k]))
                    else:
                        somatorio_feromonio = 0
